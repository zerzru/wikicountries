...
<html lang="ru">
    ...
    <body>
        ...
        <div class="created_article">
            ...
            <form action="/engine/engine.unban.php" method="post">
            <textarea name="unbantext" class="article_i" placeholder="Сообщение администратору, почему вас должны разблокировать(сотрите этот текст)"></textarea> <br>
